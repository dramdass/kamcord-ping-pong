...
{
    new Firebase("https://crackling-heat-5835.firebaseio.com/ping-pong/matches/").on("value", handleMatches);
    new Firebase("https://crackling-heat-5835.firebaseio.com/ping-pong/pending/").on("value", handlePending);
    initClickHandlers();
});
...
function submitNewMatch()
{
    ...
    var matchRef = new Firebase("https://crackling-heat-5835.firebaseio.com/ping-pong/pending/").push(match);
...
function acceptPendingMatch(key, match)
{
    ...
    {
        new Firebase("https://crackling-heat-5835.firebaseio.com/ping-pong/pending").child(key).remove();
        $("#auth_background").fadeOut(200);
    });
}
